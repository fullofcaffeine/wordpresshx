...
assert reflaxe_php_semantic_receipt["localEvidence"][
    ...
    "current-string-less-than-subject-pending-hosted; "
...
assert reflaxe_php_semantic_receipt["hostedVerification"] == {
    "relation": "current-string-inequality-subject",
    ...
    "scope": (
        "the current 82 exact admitted semantic records with strict String inequality "
...
assert reflaxe_php_semantic_receipt["previousHostedVerification"] == {
    "relation": "predecessor-int-inequality-subject",
    "admittedCapabilityCount": 80,
    "workflow": "Repository bootstrap",
    "runId": 31552581279,
    "url": "https://github.com/fullofcaffeine/wordpresshx/actions/runs/31552581279",
    "commit": "4f97f5e7fc42557fe7c5c9834965f96efa319f24",
    "status": "passed",
    "job": {
        "name": "haxe",
        "jobId": 93978235292,
        "url": (
            "https://github.com/fullofcaffeine/wordpresshx/actions/runs/"
            "31552581279/job/93978235292"
        ),
        "status": "passed",
        "completedAt": "2026-08-12T01:24:12Z",
    },
    "exactPhpVersions": ["7.4.33", "8.4.7"],
    "requiredSteps": [
        "Install Haxe 4.3.7",
    ...
    "scope": (
        "the predecessor 80 exact admitted semantic records with strict Int inequality "
        "for exact Int operands, a typed source-owned Int predicate call, deterministic generic compiler output, "
...
assert reflaxe_php_module_output_receipt["hostedVerification"] == {
    "relation": "current-string-inequality-module-graph-subject",
    "workflow": "Repository bootstrap",
    "runId": 32506395234,
    "url": "https://github.com/fullofcaffeine/wordpresshx/actions/runs/32506395234",
    "commit": "0cf7a18ae37c7e4d29ec27f6073d7a6b99993b00",
    ...
    "scope": (
        "the current compiler package with strict String inequality for exact non-null String operands "
...
assert reflaxe_php_module_output_receipt["previousHostedVerification"] == {
    "relation": "predecessor-int-inequality-module-graph-subject",
    "workflow": "Repository bootstrap",
    "runId": 31552581279,
    "url": "https://github.com/fullofcaffeine/wordpresshx/actions/runs/31552581279",
    "commit": "4f97f5e7fc42557fe7c5c9834965f96efa319f24",
    ...
    "scope": (
        "the predecessor compiler package with strict Int inequality for exact Int operands "
        "and a typed source-owned Int predicate call, a clean package consumer, the exact PHP runtime matrix, "
