...
assert reflaxe_php_semantic_receipt["localEvidence"][
    ...
    "current-61-capability-subject-hosted-pending; "
    "predecessor-59-capability-subject-passed-run-30753775194"
)
...
assert reflaxe_php_semantic_receipt["previousHostedVerification"] == {
    "relation": "predecessor-59-capability-subject-only",
    "admittedCapabilityCount": 59,
    "workflow": "Repository bootstrap",
    "runId": 30753775194,
    "url": "https://github.com/fullofcaffeine/wordpresshx/actions/runs/30753775194",
    "commit": "47b1b66ea8638fcc2755435d18e85f8597306697",
    "status": "passed",
    "job": {
        "name": "haxe",
        "jobId": 91512308969,
        "url": (
            ...
            "30753775194/job/91512308969"
        ),
        "status": "passed",
        "completedAt": "2026-08-02T15:26:51Z",
    },
    ...
    "scope": (
        "the predecessor 59-capability subject, deterministic generic "
