...
assert reflaxe_php_semantic_receipt["localEvidence"][
    ...
    "current-59-capability-subject-passed-run-30753775194"
)
...
assert reflaxe_php_semantic_receipt["hostedVerification"] == {
    "relation": "current-59-capability-subject",
    ...
    "scope": (
        "the current 59 exact admitted semantic records, deterministic generic "
