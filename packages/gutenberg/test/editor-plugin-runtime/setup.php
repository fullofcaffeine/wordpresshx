...
$post_id = wp_insert_post(
    array(
        'post_title' => 'Typed release note',
        'post_content' => '<!-- wp:paragraph --><p>Editor proof.</p><!-- /wp:paragraph -->',
        'post_status' => 'draft',
        'post_type' => 'post',
        'post_author' => 1,
    ),
...
$page_id = wp_insert_post(
    array(
        'post_title' => 'Unsupported page',
        'post_content' => '<!-- wp:paragraph --><p>Visibility negative.</p><!-- /wp:paragraph -->',
        'post_status' => 'draft',
        'post_type' => 'page',
        'post_author' => 1,
    ),
...
if (is_wp_error($post_id) || is_wp_error($page_id)) {
    fwrite(STDERR, "unable to seed editor fixtures\n");
    exit(1);
}

echo wp_json_encode(
    array(
        'check' => 'wordpresshx-sdk063-editor-setup-v1',
        'pageId' => $page_id,
