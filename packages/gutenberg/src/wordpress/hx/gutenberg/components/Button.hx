 ...
 *
 * `@:genes.jsxComponentProps` gives Genes the closed Haxe contract for Button
 ...
 */
@:genes.jsxComponentProps("wordpress.hx.gutenberg.components.ButtonProps")
@:jsRequire("@wordpress/components", "Button")
extern class Button {}
