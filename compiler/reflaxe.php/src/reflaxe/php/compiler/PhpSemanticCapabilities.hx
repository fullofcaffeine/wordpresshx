...
enum abstract PhpSemanticCapabilityId(String) to String {
	...
	var IntArrayPopDiscarded = "collection.int-array-pop-discarded";
	var ProvenIntArrayRead = "collection.proven-int-array-read";
	var ProvenIntArrayWrite = "collection.proven-int-array-write";
	...
	var StringGreaterOrEqual = "ordering.string-greater-or-equal";
...
class PhpSemanticCapabilities {
	public static function records():Array<PhpSemanticCapabilityRecord> {
		...
		return [
			...
			record(IntArrayPopDiscarded, ValuesCollections, Admitted, semantic, owner),
			record(ProvenIntArrayRead, ValuesCollections, Admitted, semantic, owner),
			record(ProvenIntArrayWrite, ValuesCollections, Admitted, semantic, owner),
			...
			record(StringGreaterOrEqual, Ordering, Admitted, semantic, owner),
			...
			record(ArrayCollection, ValuesCollections, UnsupportedOwned,
				"general Array runtime behavior beyond fixed Int literals, exact length, proven reads/writes, and direct result-discarded push/pop is rejected",
				owner),
